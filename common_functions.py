...
import processing
from qgis.core import Qgis, QgsField, QgsMessageLog, QgsProcessingException, QgsWkbTypes
...
def construct_sql_taxons_filter(taxons_dict):
    ...
    if len(rank_filters) > 0:
        ...
        QgsMessageLog.logMessage(taxons_where)
        return taxons_where
...
def construct_sql_datetime_filter(
    ...
    QgsMessageLog.logMessage(datetime_where)
