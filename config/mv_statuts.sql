...
CREATE INDEX mv_c_statut_lr_aura_idx ON taxonomie.mv_c_statut USING btree (lr_aura);
CREATE INDEX mv_c_statut_lr_auv_idx ON taxonomie.mv_c_statut USING btree (lr_auv);
CREATE INDEX mv_c_statut_lr_france_idx ON taxonomie.mv_c_statut USING btree (lr_france);
