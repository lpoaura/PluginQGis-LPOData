...
class SummaryMap(BaseQgsProcessingAlgorithm):
    layer_map = None
    ...
    def initAlgorithm(self, _config=None):
        ...
        QgsMessageLog.logMessage('after init message')
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        where_filters_list = []
        where_filters_list.append(taxons_where)
        ...
        (sink, dest_id) = self.parameterAsSink(
            ...
            context,
            new_fields,
            self.layer_map.wkbType(),
            self.layer_map.sourceCrs(),
        )
        if sink is None:
    ...
    def postProcessAlgorithm(self, _context, _feedback):
